...
const url = "mongodb://localhost/weight_tracker";//"mongodb+srv://Craig:Cool2003!@cluster0-aqejs.mongodb.net/test?retryWrites=true&w=majority"; // Use enviroment variable on Heroku, local db for local development
mongoose
  .connect(url, {
